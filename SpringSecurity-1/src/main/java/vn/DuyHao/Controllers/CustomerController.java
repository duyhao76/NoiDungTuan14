...
import vn.DuyHao.Models.Customer;

@RestController
@EnableMethodSecurity
public class CustomerController {
	final private List<Customer> customers = List.of(
			Customer.builder().id("001").name("Nguyễn Duy Hào").email("ndhao2509@gmail.com").build(),
			Customer.builder().id("002").name("Trần Trọng Thức").email("thuctran@gmail.com").build()
			);
